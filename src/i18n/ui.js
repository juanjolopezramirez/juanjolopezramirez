...
export const UI = {
    en: {
      ...
      'panel.title': 'I create brand strategy built from the foundation.',
      'panel.intro': 'Through my work, I aim to:',
      'panel.p1': 'Shape strategic heirs.',
      'panel.p2': 'Share stories through the spirit of Timothy.',
      'panel.p3': 'Remember the origin of truth.',
      'panel.p4': 'Share my roots in the mountains of Cundinamarca, Colombia.',
      'quote.who': 'Rhema',
      'soon.badge': 'Soon',
      ...
      'hero.emet': 'projects aligned with Truth (Emet): where purpose is inseparable from the Origin and that which truly endures.',
    ...
    es: {
      ...
      'panel.title': 'Creo estrategia de marca construida desde el cimiento.',
      'panel.intro': 'A través de mi trabajo, busco:',
      'panel.p1': 'Formar herederos estratégicos.',
      'panel.p2': 'Compartir historias a través del espíritu de Timoteo.',
      'panel.p3': 'Recordar el origen de la verdad.',
      'panel.p4': 'Dar a conocer mis raíces en las montañas de Cundinamarca, Colombia.',
      'quote.who': 'Rhema',
      'soon.badge': 'Pronto',
      ...
      'hero.emet': 'proyectos alineados con la Verdad (Emet): donde el propósito no se separa del Origen y lo que realmente permanece.',
    ...
    pt: {
      ...
      'panel.title': 'Crio estratégia de marca construída desde a base.',
      'panel.intro': 'Através do meu trabalho, busco:',
      'panel.p1': 'Formar herdeiros estratégicos.',
      'panel.p2': 'Compartilhar histórias através do espírito de Timóteo.',
      'panel.p3': 'Recordar a origem da verdade.',
      'panel.p4': 'Dar a conhecer as minhas raízes nas montanhas de Cundinamarca, Colômbia.',
      'quote.who': 'Rhema',
      'soon.badge': 'Em breve',
      ...
      'hero.emet': 'projetos alinhados com a Verdade (Emet): onde o propósito não se separa da Origem nem daquilo que realmente permanece.',
    ...
    fr: {
      ...
      'panel.title': 'Je crée une stratégie de marque construite depuis la fondation.',
      'panel.intro': 'À travers mon travail, je cherche à :',
      'panel.p1': 'Former des héritiers stratégiques.',
      'panel.p2': 'Partager des histoires à travers l’esprit de Timothée.',
      'panel.p3': 'Rappeler l’origine de la vérité.',
      'panel.p4': 'Faire connaître mes racines dans les montagnes de Cundinamarca, en Colombie.',
      'quote.who': 'Rhèma',
      'soon.badge': 'Bientôt',
      ...
      'hero.emet': 'des projets alignés sur la Vérité (Emet) : où le dessein ne se sépare ni de l’Origine ni de ce qui demeure vraiment.',
    ...
    it: {
      ...
      'panel.title': 'Creo strategie di marca costruite dalle fondamenta.',
      'panel.intro': 'Attraverso il mio lavoro, cerco di:',
      'panel.p1': 'Formare eredi strategici.',
      'panel.p2': 'Condividere storie attraverso lo spirito di Timoteo.',
      'panel.p3': 'Ricordare l’origine della verità.',
      'panel.p4': 'Far conoscere le mie radici sulle montagne di Cundinamarca, in Colombia.',
      'quote.who': 'Rhema',
      'soon.badge': 'Presto',
      ...
      'hero.emet': 'progetti allineati con la Verità (Emet): dove il proposito non si separa dall’Origine né da ciò che davvero permane.',
