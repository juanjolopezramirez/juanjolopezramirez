/* Con quienes he caminado. El orden de este array es el orden en que
   ...
   marca: por eso la cinta va sobre Slate y no sobre hueso — en hueso no
   se verian. Al anadir uno nuevo, comprueba que sea claro; si viene en
   oscuro, no sirve para este fondo. */
export const PARTNERS = [
  { id: 'casa-san-pedro', name: 'Casa San Pedro', src: '/assets/partners/casa-san-pedro.svg', w: 287, h: 220 },
  { id: 'bodega',         name: 'Bodega',         src: '/assets/partners/bodega.png',         w: 480, h: 193, webp: '/assets/partners/bodega.webp' }
];
